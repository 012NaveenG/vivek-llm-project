...
const initialProducts: Product[] = [
    {
        ...
        comments: [
            { name: "Aman", text: "Sound quality is amazing!" },
            { name: "Priya", text: "Loved the design and comfort." }
        ],
        svg: (
    ...
    },
    {
        ...
        comments: [
            { name: "Ravi", text: "Value for money." },
            { name: "Sneha", text: "Perfect for my workouts!" }
        ],
        svg: (
            <svg className="w-full h-64 product-image" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
    ...
    },
    {
        ...
        comments: [
            { name: "Kunal", text: "Battery backup is awesome." },
            { name: "Meera", text: "Perfect for outdoor parties!" }
        ],
        svg: (
            <svg className="w-full h-64 product-image" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
    ...
    },
    {
        ...
        comments: [
            { name: "Raj", text: "Charges my phone super fast!" },
            { name: "Neha", text: "No heating issue at all." }
        ],
        svg: (
            <svg className="w-full h-64 product-image" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
        ...
        <div >
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                        ...
                        {products.map((product, idx) => (
                            <div
                                ...
                                className="product-card bg-white rounded-xl shadow-md overflow-hidden transition duration-300" data-product-id="1">
                                <div className="relative">
            ...
            {selectedProduct && (
                <div className="fixed inset-0 z-50 bg-black bg-opacity-50 flex justify-center items-center">
                    <div className="bg-white  overflow-y-auto scrollbar-hidden h-[80vh] rounded-lg p-6 w-full max-w-3xl relative">
                        <button
                        ...
                        <div className="flex flex-col md:flex-row gap-4">
                            <div className="w-full md:w-1/2 bg-gray-100">{selectedProduct.svg}</div>
                            <div className="flex-1">
                                <h2 className="text-2xl text-neutral-700 font-bold">{selectedProduct.title}</h2>
                                <div className="flex items-center gap-3 mt-2">
                                    <span className="text-purple-600 font-bold text-xl">${selectedProduct.price.toFixed(2)}</span>
                        ...
                        <div className="mt-6">
                            ...
                            <div className="max-h-60 overflow-y-auto space-y-4 scrollbar-hidden">
                                {selectedProduct.comments.length > 0 ? (
                                    selectedProduct.comments.map((cmt, idx) => (
                                        <div key={idx} className="border-b pb-2">
                                            <div className="flex justify-between text-sm text-gray-600">
                                                <span className="font-medium">{cmt.name}</span>
                                                {"date" in cmt && <span>{(cmt as any).date}</span>}
                                            </div>
                                            <div className="text-yellow-400 flex">
                                                {[...Array(5)].map((_, i) => (
                                                    <span key={i}>{i < (cmt as any).rating ? "★" : "☆"}</span>
                                                ))}
                                            </div>
                            ...
                            <div className="mt-4 space-y-2">
                                <input
                                    className="w-full text-neutral-700 border-neutral-500 border p-2 rounded"
